...
const notesApi: NotesApi = {
  ...
  listVersions: (noteId) => ipcRenderer.invoke("notes:list-versions", noteId),
  restoreVersion: (noteId, versionId) => ipcRenderer.invoke("notes:restore-version", noteId, versionId),
