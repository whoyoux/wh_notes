...
const translations = {
  en: {
    ...
    searchNotesDescription: "Search titles and note text.",
    searchPlaceholder: "Search notes…",
    searchStart: "Type to search your notes.",
  ...
  pl: {
    ...
    searchNotesDescription: "Szukaj w tytułach i treści notatek.",
    searchPlaceholder: "Szukaj notatek…",
    searchStart: "Zacznij pisać, aby przeszukać notatki.",
