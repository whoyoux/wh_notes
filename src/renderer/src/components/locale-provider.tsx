...
const translations = {
  en: {
    ...
    commandPaletteDescription: "Search notes or run an action.",
    commandActions: "Actions",
    versionHistory: "Version history",
    versionHistoryDescription: "Earlier local versions of this note.",
    versionHistoryLoadFailed: "Couldn't load version history.",
    versionRestoreFailed: "Couldn't restore this version.",
  ...
  pl: {
    ...
    commandPaletteDescription: "Szukaj notatek lub uruchom polecenie.",
    commandActions: "Polecenia",
    versionHistory: "Historia wersji",
    versionHistoryDescription: "Wcześniejsze lokalne wersje tej notatki.",
    versionHistoryLoadFailed: "Nie udało się wczytać historii wersji.",
    versionRestoreFailed: "Nie udało się przywrócić tej wersji.",
    noVersions: "Nie ma jeszcze wcześniejszych wersji.",
    restoreVersion: "Przywróć",
    close: "Zamknij",
    saveNow: "Zapisz teraz",
    exportCurrentNote: "Eksportuj bieżącą notatkę",
    searchNotes: "Szukaj notatek",
    searchPlaceholder: "Szukaj notatek…",
    searchNoResults: "Brak pasujących notatek.",
    ...
    taskNotCompleted: "Zadanie nieukończone",
    quote: "Cytat",
    codeBlock: "Blok kodu",
